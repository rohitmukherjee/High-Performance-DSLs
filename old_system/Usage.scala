...
val sleekTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/sleek.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "sleek.out" checkAgainst "Valid, Valid, Valid, Fail"
...
val sleek9Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/sleek9.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "sleek9.out" checkAgainst "Valid, Valid,"
...
val symb_diffTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/symb-diff.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "symb_diff.out" checkAgainst "Valid, Valid, Valid"
symb_diffTest.build generateOutput()

val xpure3nodesTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/xpure3nodes.slk" withArguments "" storeOutputInDirectory "results" withOutputFileName "xpure3nodes.out" checkAgainst "Valid, Valid"
xpure3nodesTest.build generateOutput()

val infer_app_invTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/app-inv.slk" withArguments " --inv --dis-eps" storeOutputInDirectory "results" withOutputFileName "infer_app_inv.out" checkAgainst "Valid, Valid, Fail, Valid, Valid, Valid"
infer_app_invTest.build generateOutput()

val infer_app_inv2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/app-inv2.slk" withArguments " --inv --dis-eps" storeOutputInDirectory "results" withOutputFileName "infer_app_inv2.out" checkAgainst "Valid, Valid, Valid, Fail"
infer_app_inv2Test.build generateOutput()

val infer_infer1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer1.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer1.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid"
infer_infer1Test.build generateOutput()

val infer_infer2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer2.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer2.out" checkAgainst "Valid, Valid, Valid, Fail, Valid, Fail, Valid, Valid, Fail"
infer_infer2Test.build generateOutput()

val infer_infer4Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer4.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer4.out" checkAgainst "Fail, Fail, Val"
infer_infer4Test.build generateOutput()

val infer_infer5Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer5.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer5.out" checkAgainst "Valid, Valid, Fail, Valid"
infer_infer5Test.build generateOutput()

val infer_infer5aTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer5a.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer5a.out" checkAgainst "Fail, Valid"
infer_infer5aTest.build generateOutput()

val infer_infer6Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer6.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer6.out" checkAgainst "Valid"
infer_infer6Test.build generateOutput()

val infer_infer7Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer7.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer7.out" checkAgainst "Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Fail, Valid"
infer_infer7Test.build generateOutput()

val infer_infer8Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer8.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer8.out" checkAgainst "Valid, Valid, Valid, Fail, Fail, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Fail, Fail, Valid, Valid, Valid"
infer_infer8Test.build generateOutput()

val infer_infer9Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer9.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer9.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Fail, Valid, Fail, Valid, Valid"
infer_infer9Test.build generateOutput()

val infer_infer10Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer10.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer10.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Fail, Fail, Fail, Valid"
infer_infer10Test.build generateOutput()

val infer_infer11Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer11.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer11.out" checkAgainst "Fail"
...
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer14.slk" withArguments " --sa-en-pure-field" storeOutputInDirectory "results" withOutputFileName "infer_infer14.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid"
infer_infer14Test.build generateOutput()

val infer_infer15Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer15.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer15.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid"
infer_infer15Test.build generateOutput()

val infer_infer16Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infer/infer16.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "infer_infer16.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid"
infer_infer16Test.build generateOutput()

val ann2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/ann2.slk" withArguments "  --imm --en-imm-inv --etcsu1 " storeOutputInDirectory "results" withOutputFileName "ann2.out" checkAgainst "Valid, Valid, Valid, Fail, Valid, Valid, Fail, Fail, Valid, Valid, Valid, Valid, Valid, Fail, Fail, Valid, Fail, Valid, Fail, Fail, Valid, Valid, Valid, Fail, Fail"
ann2Test.build generateOutput()

val imm_imm1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm/imm1.slk" withArguments "  --imm --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_imm1.out" checkAgainst "Fail, Valid, Valid, Valid, Valid, Valid"
imm_imm1Test.build generateOutput()

val imm_imm2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm/imm2.slk" withArguments "  --imm --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_imm2.out" checkAgainst "Fail, Valid, Fail, Valid, Fail"
imm_imm2Test.build generateOutput()

val imm_imm3Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm/imm3.slk" withArguments "  --imm --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_imm3.out" checkAgainst "Fail, Fail, Valid, Valid, Valid"
imm_imm3Test.build generateOutput()

val imm_imm4Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm/imm4.slk" withArguments "  --imm --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_imm4.out" checkAgainst "Valid, Fail"
imm_imm4Test.build generateOutput()

val imm_imm_hardTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm/imm-hard.slk" withArguments "  --imm --eps" storeOutputInDirectory "results" withOutputFileName "imm_imm_hard.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid"
imm_imm_hardTest.build generateOutput()

val imm_field_sleek01Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm-field/sleek01.slk" withArguments "  --field-ann --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_field_sleek01.out" checkAgainst "Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail"
imm_field_sleek01Test.build generateOutput()

val imm_field_sleek02Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm-field/sleek02.slk" withArguments "  --field-ann --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_field_sleek02.out" checkAgainst "Fail, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Fail"
imm_field_sleek02Test.build generateOutput()

val imm_field_sleek03Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/imm-field/sleek03.slk" withArguments "  --field-ann --etcsu1 " storeOutputInDirectory "results" withOutputFileName "imm_field_sleek03.out" checkAgainst "Valid, Fail, Valid, Valid, Fail, Valid, Valid, Fail, Valid, Valid, Fail"
imm_field_sleek03Test.build generateOutput()

val epsTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/eps.slk" withArguments "  --dis-imm " storeOutputInDirectory "results" withOutputFileName "eps.out" checkAgainst "Valid"
...
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/classic/classic2.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "classic_classic2.out" checkAgainst "Fail, Valid, Valid, Valid, Fail, Valid, Fail, Fail"
classic_classic2Test.build generateOutput()

val classic_classic3Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/classic/classic3.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "classic_classic3.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Fail, Fail"
classic_classic3Test.build generateOutput()

val classic_classic4Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/classic/classic4.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "classic_classic4.out" checkAgainst "Valid, Fail, Valid, Fail, Valid, Fail, Valid, Fail"
classic_classic4Test.build generateOutput()

val inf_no_epsTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/inf-no-eps.slk" withArguments "--dsd --en-inf --dis-eps" storeOutputInDirectory "results" withOutputFileName "inf_no_eps.out" checkAgainst "Fail, Fail, Valid, Valid"
inf_no_epsTest.build generateOutput()

val infinityTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/infinity.slk" withArguments "--dsd --en-inf --dis-eps" storeOutputInDirectory "results" withOutputFileName "infinity.out" checkAgainst "Fail, Valid, Valid, Fail, Valid, Valid, Fail, Valid, Valid, Valid, Fail, Valid, Valid, Fail, Fail, Valid, Fail, Valid, Fail, Fail, Valid, Valid, Fail, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Fail, Valid, Fail, Valid, Valid, Valid, Fail, Fail, Valid, Fail, Fail, Valid, Valid, Valid, Valid, Valid, Fail, Fail, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Fail, Valid, Valid, Valid, Valid, Valid"
infinityTest.build generateOutput()

val inflemTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/inflem.slk" withArguments "  --en-inf --elp --dis-eps" storeOutputInDirectory "results" withOutputFileName "inflem.out" checkAgainst "Valid,"
inflemTest.build generateOutput()

val lemmas_sort2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/sort2.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_sort2.out" checkAgainst "Fail, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Fail, Valid,"
lemmas_sort2Test.build generateOutput()

val lemmas_lsegTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/lseg.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_lseg.out" checkAgainst "Valid, Valid, Valid, Valid,"
lemmas_lsegTest.build generateOutput()

val lemmas_lseg1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/lseg1.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_lseg1.out" checkAgainst "Valid,"
lemmas_lseg1Test.build generateOutput()

val lemmas_rlsegTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/rlseg.slk" withArguments "  --elp --dis-lem-gen" storeOutputInDirectory "results" withOutputFileName "lemmas_rlseg.out" checkAgainst "Valid, Valid, Valid,"
lemmas_rlsegTest.build generateOutput()

val lemmas_lemma_foldTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/lemma-fold.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "lemmas_lemma_fold.out" checkAgainst "Valid,"
lemmas_lemma_foldTest.build generateOutput()

val lemmas_rd_lem_1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/rd-lem-1.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_rd_lem_1.out" checkAgainst "Fail, Valid,"
lemmas_rd_lem_1Test.build generateOutput()

val lemmas_rd_lem_2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/rd-lem-2.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "lemmas_rd_lem_2.out" checkAgainst "Fail"
lemmas_rd_lem_2Test.build generateOutput()

val lemmas_app_tailTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/app-tail.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "lemmas_app_tail.out" checkAgainst "Valid, Valid,"
lemmas_app_tailTest.build generateOutput()

val lemmas_lseg_caseTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/lseg_case.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_lseg_case.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid,"
lemmas_lseg_caseTest.build generateOutput()

val lemmas_llTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/ll.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "lemmas_ll.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid,"
lemmas_llTest.build generateOutput()

val lemmas_ll_tailTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/ll_tail.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "lemmas_ll_tail.out" checkAgainst "Valid, Valid"
lemmas_ll_tailTest.build generateOutput()

val lemmas_nlseg3Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/nlseg3.slk" withArguments " " storeOutputInDirectory "results" withOutputFileName "lemmas_nlseg3.out" checkAgainst "Valid, Valid"
lemmas_nlseg3Test.build generateOutput()

val lemmas_nlseg4eTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/nlseg4e.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "lemmas_nlseg4e.out" checkAgainst "Valid, Valid"
lemmas_nlseg4eTest.build generateOutput()

val lemmas_nlseg4e1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/nlseg4e1.slk" withArguments " --dis-imm" storeOutputInDirectory "results" withOutputFileName "lemmas_nlseg4e1.out" checkAgainst "Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid"
lemmas_nlseg4e1Test.build generateOutput()

val lemmas_sll_tailLTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/sll_tailL.slk" withArguments "  --elp " storeOutputInDirectory "results" withOutputFileName "lemmas_sll_tailL.out" checkAgainst "Valid, Valid"
lemmas_sll_tailLTest.build generateOutput()

val lemmas_dseg_newTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/dseg-new.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_dseg_new.out" checkAgainst "Valid, Fail, Valid,"
lemmas_dseg_newTest.build generateOutput()

val lemmas_dseg1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/dseg1.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_dseg1.out" checkAgainst "Valid, Fail,"
lemmas_dseg1Test.build generateOutput()

val lemmas_odd_lsegTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/odd-lseg.slk" withArguments "  --elp --dis-lem-gen --dis-eps" storeOutputInDirectory "results" withOutputFileName "lemmas_odd_lseg.out" checkAgainst "Valid, Valid,"
lemmas_odd_lsegTest.build generateOutput()

val lemmas_lseg_complexTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/lemmas/lseg_complex.slk" withArguments "  --elp --dis-lem-gen " storeOutputInDirectory "results" withOutputFileName "lemmas_lseg_complex.out" checkAgainst "Valid, Valid, Valid"
...
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/conchip/threads.slk" withArguments " -tp parahip" storeOutputInDirectory "results" withOutputFileName "conchip_threads.out" checkAgainst "Valid, Valid, Val"
...
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek.out" checkAgainst "Valid, Valid, Valid, Fail"
fracperm_sleekTest.build generateOutput()

val fracperm_sleek1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek1.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek1.out" checkAgainst "Fail"
fracperm_sleek1Test.build generateOutput()

val fracperm_sleek10Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek10.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek10.out" checkAgainst "Valid, Fail"
fracperm_sleek10Test.build generateOutput()

val fracperm_sleek2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek2.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek2.out" checkAgainst "Fail, Valid, Fail, Fail, Valid, Valid, Valid, Fail"
fracperm_sleek2Test.build generateOutput()

val fracperm_sleek3Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek3.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek3.out" checkAgainst "Valid, Fail, Valid"
fracperm_sleek3Test.build generateOutput()

val fracperm_sleek4Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek4.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek4.out" checkAgainst "Valid, Valid"
fracperm_sleek4Test.build generateOutput()

val fracperm_sleek6Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek6.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek6.out" checkAgainst "Valid, Valid"
fracperm_sleek6Test.build generateOutput()

val fracperm_sleek7Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek7.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek7.out" checkAgainst "Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Fail, Valid"
fracperm_sleek7Test.build generateOutput()

val fracperm_sleek8Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek8.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek8.out" checkAgainst "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Fail, Valid, Fail"
fracperm_sleek8Test.build generateOutput()

val fracperm_sleek9Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/sleek9.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_sleek9.out" checkAgainst "Valid, Fail, Valid, Valid"
fracperm_sleek9Test.build generateOutput()

val fracperm_norm1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/norm1.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_norm1.out" checkAgainst "Fail, Valid, Fail, Valid"
fracperm_norm1Test.build generateOutput()

val fracperm_norm3Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/norm3.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_norm3.out" checkAgainst "Fail, Valid, Valid, Valid, Valid, Valid, Valid, Fail"
fracperm_norm3Test.build generateOutput()

val fracperm_norm4Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/norm4.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_norm4.out" checkAgainst "Valid, Valid, Valid"
fracperm_norm4Test.build generateOutput()

val fracperm_uni_varsTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/uni_vars.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_uni_vars.out" checkAgainst "Valid, Valid, Fail"
fracperm_uni_varsTest.build generateOutput()

val fracperm_frac1Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/frac1.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_frac1.out" checkAgainst "Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid"
fracperm_frac1Test.build generateOutput()

val fracperm_frac2Test = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/fracperm/frac2.slk" withArguments "--en-para -perm fperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "fracperm_frac2.out" checkAgainst "Valid, Fail, Valid, Valid, Valid, Fail, Fail, Valid, Valid, Fail, Valid, Fail, Fail"
...
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/veribsync/bperm1.slk" withArguments "--en-para -perm bperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "veribsync_bperm1.out" checkAgainst "Valid, Fail, Valid, Valid, Valid, Valid, Valid, Fail"
veribsync_bperm1Test.build generateOutput()

val veribsync_bperm_splitTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/veribsync/bperm-split.slk" withArguments "--en-para -perm bperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "veribsync_bperm_split.out" checkAgainst "Valid, Valid, Fail, Valid, Valid, Fail, Valid, Valid"
...
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/veribsync/barrier-split.slk" withArguments "--en-para -perm bperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "veribsync_barrier_split.out" checkAgainst "Valid, Valid, Fail, Valid, Valid, Fail, Valid"
veribsync_barrier_splitTest.build generateOutput()

val veribsync_barrier_combineTest = 
new SleekTestCaseBuilder runCommand "sleek" onFile "/home/rohit/hg/sleek_hip/examples/working/sleek/veribsync/barrier-combine.slk" withArguments "--en-para -perm bperm -tp redlog" storeOutputInDirectory "results" withOutputFileName "veribsync_barrier_combine.out" checkAgainst "Valid, Valid, Valid, Valid"
